...
object FunctionalAssignment {
  ...
  //
  /** the function op gets a value of type A and forms a list out of it, it also gets an accumulator and a function
    * as parameters. then op executes a foldleft operation with the list, the accumulator and the function
    *
    * With the new names the code got more understandable for others,
    * but it also got longer
    *
    *
    * @param list
    * @param accumulator
    ...
    * @return
    */
  def op[typeA, typeB](list: Seq[typeA], accumulator: typeB)(function: (typeB, typeA) => typeB): typeB = list.foldLeft(accumulator)(function)
